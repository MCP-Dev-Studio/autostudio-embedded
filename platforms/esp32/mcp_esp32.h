...
typedef struct {
    ...
    bool enableBLE;             // Enable Bluetooth Low Energy
    uint16_t serverPort;        // Server port (for TCP)
    bool autoStartServer;       // Automatically start server
    bool enableOTA;             // Enable over-the-air updates
    bool enableWebServer;       // Enable web server
    uint16_t webServerPort;     // Web server port
} MCP_ESP32Config;
